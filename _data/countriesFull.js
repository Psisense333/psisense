// src/data/countriesFull.js

/*
  Full UN Member & Observer States
  Format 3:
    - CENTROIDS: geographic center
    - CAPITALS: capital city coordinates
  Keys are ISO 3166-1 alpha-2 codes.
  Values include name with coordinates.
*/
...
export const CENTROIDS = {
  ...
  CD: { name: "Congo (DRC)", lat: -4.0383, lng: 21.7587 },
  CG: { name: "Congo (Republic)", lat: -0.2280, lng: 15.8277 },
  CR: { name: "Costa Rica", lat: 9.7489, lng: -83.7534 },
  CI: { name: "Côte d’Ivoire", lat: 7.5399, lng: -5.5471 },
  ...
  DM: { name: "Dominica", lat: 15.4140, lng: -61.3700 },
  ...
  LS: { name: "Lesotho", lat: -29.609, lng: 28.233 },
  ...
  PE: { name: "Peru", lat: -9.1899, lng: -75.0152 },
  ...
  KN: { name: "Saint Kitts and Nevis", lat: 17.3578, lng: -62.7830 },
  ...
  VA: { name: "Holy See", lat: 41.9029, lng: 12.4534 },
